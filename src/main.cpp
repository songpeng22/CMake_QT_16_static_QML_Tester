...
*/
	...
	QUrl url = QUrl(QStringLiteral("qrc:/Universal_demo.qml"));//Universal_demo//Button_Standard_Test//CheckBox_Standard_Test//Label_Standard_Test//Material_demo//TextField_Standard_Test
	view.load(url);

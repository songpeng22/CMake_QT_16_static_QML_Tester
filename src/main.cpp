...
int main(int argc, char *argv[])
{
	...
	QUrl url = QUrl(QStringLiteral("qrc:/TextField_Standard_Test.qml"));//Button_Standard_Test//CheckBox_Standard_Test//Label_Standard_Test//Material_demo//TextField_Standard_Test
	view.load(url);
